...
SELECT product, cost FROM store.orders ORDER BY cost;
...
# INNER JOIN orders and customers table
SELECT store.orders.product, store.orders.cost, store.customers.lastname
FROM orders
INNER JOIN customers ON orders.customerId = customers.id;

#INNER JOIN orders and customers table using WHERE command
SELECT store.orders.product, store.orders.cost, store.customers.lastname
FROM orders
INNER JOIN customers ON orders.customerId = customers.id
WHERE lastname = 'Halpert';
